...
public class _14_FindBranchByHospitalFounder {
	public static void main(String[] args) {
		Scanner s = new Scanner(System.in);
		System.out.println("Enter the founder name to get the branch details");
		String name = s.next();
		String qry = "select b from Branch b where b.hospital.founder=?1";
